...
However, depending on the sample type and metabolite class, additional isotope patterns may be relevant. For example, heteroatom-containing metabolites or natural products, particularly compounds containing S, Cl, Br, Si, or multiple O atoms, may show clear $M+2$ isotope peaks, while combined isotope contributions can also produce visible $M+3$ peaks.<br>
For these cases, a more permissive isotope search can be performed by increasing the isotope order to `n` = 2 and using a wider m/z tolerance, for example $0.015$. A broader tolerance such as $0.05$ Da; `n` = 3; $0.05$ min should be treated as a diagnostic/refinement search and interpreted carefully.<br><br>
