...
For these cases, a more permissive isotope search can be performed by increasing the isotope order to `n` = 3 and using a wider m/z tolerance, for example $0.05$ Da. This setting should be treated as an extended or diagnostic search and interpreted carefully.<br><br>
